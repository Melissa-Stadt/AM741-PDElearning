'''
 This is for generating the advection diffusion noisy data for a 
 new advection diffusion equation (i.e., different diffusion coefficient,
                                   advection coefficient and initial 
                                   conditions)
'''
